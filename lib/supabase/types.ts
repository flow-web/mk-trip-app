...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      activity_rules: {
        Row: {
          activity: Database["public"]["Enums"]["activity_kind"]
          distance_ratio_max: number
          distance_ratio_min: number
          hausdorff_tol_m: number
      ...
      guide_cards: {
        ...
        Relationships: [
          {
            foreignKeyName: "guide_cards_trip_id_fkey"
            columns: ["trip_id"]
            isOneToOne: false
            referencedRelation: "trips"
            referencedColumns: ["id"]
      ...
      runs: {
        ...
        Relationships: [
          {
            foreignKeyName: "runs_segment_id_fkey"
            columns: ["segment_id"]
            isOneToOne: false
          ...
          },
          {
            ...
            columns: ["segment_id"]
            isOneToOne: false
            referencedRelation: "segments_public"
            referencedColumns: ["id"]
          },
          {
      ...
      spots: {
        ...
        Relationships: [
          {
            foreignKeyName: "spots_day_id_fkey"
            columns: ["day_id"]
            isOneToOne: false
            referencedRelation: "days"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "spots_trip_id_fkey"
            columns: ["trip_id"]
            isOneToOne: false
            referencedRelation: "trips"
            referencedColumns: ["id"]
      ...
      trips: {
        Row: {
          ...
          hero_image_uploaded: boolean | null
    ...
    Views: {
      ...
      segments_public: {
        Row: {
          activity: Database["public"]["Enums"]["activity_kind"] | null
    ...
    Functions: {
      _compute_run_stats: {
        Args: { p_duration_ms: number; p_trace: unknown }
        Returns: {
          distance_m: number
      ...
      _validate_run: {
        Args: { p_duration_ms: number; p_segment_id: string; p_trace: unknown }
        Returns: string
      }
      ...
      create_segment_from_run: {
        Args: {
          p_activity: Database["public"]["Enums"]["activity_kind"]
    ...
    Enums: {
      activity_kind: "skate" | "run" | "bike" | "car" | "walk" | "other"
