...
const lisboaSpots: LocalSpot[] = [
  { id: `${LISBOA}-s1`, trip_id: LISBOA, name: 'Casa do Bairro', description: 'Appart 2 chambres, vue tuiles', category: 'accommodation', zone: 'Alfama', lat: 38.7117, lng: -9.1303, price: '95€/nuit', tags: ['airbnb', 'central'], created_at: NOW, updated_at: NOW },
  { id: `${LISBOA}-s2`, trip_id: LISBOA, name: 'Miradouro de Santa Luzia', description: 'Le plus joli point de vue d\'Alfama', category: 'nature', zone: 'Alfama', lat: 38.7115, lng: -9.1294, price: null, tags: ['vue', 'gratuit'], created_at: NOW, updated_at: NOW },
  { id: `${LISBOA}-s3`, trip_id: LISBOA, name: 'Taberna da Rua das Flores', description: 'Petit, sans résa, magique', category: 'food', zone: 'Chiado', lat: 38.7106, lng: -9.1422, price: '30€/tête', tags: ['portugais', 'tapas'], created_at: NOW, updated_at: NOW },
  { id: `${LISBOA}-s4`, trip_id: LISBOA, name: 'Time Out Market', description: 'Halle de chefs', category: 'food', zone: 'Cais do Sodré', lat: 38.7066, lng: -9.1457, price: '15€/tête', tags: ['rapide'], created_at: NOW, updated_at: NOW },
  { id: `${LISBOA}-s5`, trip_id: LISBOA, name: 'Mosteiro dos Jerónimos', description: 'Chef-d\'œuvre manuélin', category: 'culture', zone: 'Belém', lat: 38.6979, lng: -9.2065, price: '12€', tags: ['unesco'], created_at: NOW, updated_at: NOW },
  { id: `${LISBOA}-s6`, trip_id: LISBOA, name: 'Pastéis de Belém', description: 'La recette originale depuis 1837', category: 'food', zone: 'Belém', lat: 38.6975, lng: -9.2030, price: '1,40€/pièce', tags: ['institution'], created_at: NOW, updated_at: NOW },
  { id: `${LISBOA}-s7`, trip_id: LISBOA, name: 'Mesa de Frades', description: 'Ancienne chapelle, fado vivant', category: 'nightlife', zone: 'Alfama', lat: 38.7130, lng: -9.1273, price: '45€ + boissons', tags: ['fado', 'résa'], created_at: NOW, updated_at: NOW },
  { id: `${LISBOA}-s8`, trip_id: LISBOA, name: 'LX Factory', description: 'Concept stores · brunch · librairie Ler Devagar', category: 'culture', zone: 'Alcântara', lat: 38.7037, lng: -9.1750, price: 'libre', tags: ['shopping', 'café'], created_at: NOW, updated_at: NOW },
]
...
const corseSpots: LocalSpot[] = [
  { id: `${CORSE}-s1`, trip_id: CORSE, name: 'Erbalunga', description: 'Village de pêcheurs marine de Cap Corse', category: 'culture', zone: 'Cap Corse', lat: 42.7560, lng: 9.4860, price: 'libre', tags: ['village', 'apéro'], created_at: NOW, updated_at: NOW },
  { id: `${CORSE}-s2`, trip_id: CORSE, name: 'Plage de Tamarone', description: 'Cristalline, déserte hors-saison', category: 'nature', zone: 'Cap Corse', lat: 43.0177, lng: 9.4533, price: null, tags: ['plage', 'turquoise'], created_at: NOW, updated_at: NOW },
  { id: `${CORSE}-s3`, trip_id: CORSE, name: 'Saleccia (Agriates)', description: 'Plage du désert, accès bateau ou 4×4', category: 'nature', zone: 'Nebbio', lat: 42.7728, lng: 9.1881, price: '17€ bateau', tags: ['accès difficile'], created_at: NOW, updated_at: NOW },
  { id: `${CORSE}-s4`, trip_id: CORSE, name: 'Citadelle de Calvi', description: 'Vue baie, ruelles vivantes', category: 'culture', zone: 'Balagne', lat: 42.5667, lng: 8.7569, price: 'libre', tags: ['fortification'], created_at: NOW, updated_at: NOW },
  { id: `${CORSE}-s5`, trip_id: CORSE, name: 'Calanche de Piana', description: 'Patrimoine Unesco, roches rouges', category: 'nature', zone: 'Ouest', lat: 42.2522, lng: 8.6300, price: null, tags: ['unesco', 'sunset'], created_at: NOW, updated_at: NOW },
  { id: `${CORSE}-s6`, trip_id: CORSE, name: 'Scandola', description: 'Réserve naturelle, accès bateau seulement', category: 'activity', zone: 'Ouest', lat: 42.3667, lng: 8.5500, price: '55€/pers', tags: ['bateau', 'unesco'], created_at: NOW, updated_at: NOW },
  { id: `${CORSE}-s7`, trip_id: CORSE, name: 'Pointe de la Parata', description: 'Tour génoise + Iles Sanguinaires', category: 'nature', zone: 'Ajaccio', lat: 41.9111, lng: 8.6056, price: 'libre', tags: ['sunset', 'rando courte'], created_at: NOW, updated_at: NOW },
  { id: `${CORSE}-s8`, trip_id: CORSE, name: 'Bonifacio — citadelle', description: 'Falaises de calcaire, ville haute', category: 'culture', zone: 'Sud', lat: 41.3878, lng: 9.1597, price: 'parking 6€', tags: ['village', 'falaise'], created_at: NOW, updated_at: NOW },
  { id: `${CORSE}-s9`, trip_id: CORSE, name: 'Palombaggia', description: 'Pins parasol, eau cristalline', category: 'nature', zone: 'Porto-Vecchio', lat: 41.5544, lng: 9.3344, price: 'parking 5€', tags: ['plage'], created_at: NOW, updated_at: NOW },
  { id: `${CORSE}-s10`, trip_id: CORSE, name: 'Lac de Melu', description: 'Lac glaciaire, montée 1h30', category: 'nature', zone: 'Restonica', lat: 42.2589, lng: 9.0489, price: 'parking 6€', tags: ['rando', 'altitude'], created_at: NOW, updated_at: NOW },
  { id: `${CORSE}-s11`, trip_id: CORSE, name: 'Domaine de Torraccia', description: 'Vins corses, dégustation libre', category: 'food', zone: 'Lecci', lat: 41.6800, lng: 9.3633, price: '8€ déguste', tags: ['vin', 'bio'], created_at: NOW, updated_at: NOW },
  { id: `${CORSE}-s12`, trip_id: CORSE, name: 'U Museu', description: 'Cabri rôti, ambiance familiale Corte', category: 'food', zone: 'Corte', lat: 42.3061, lng: 9.1492, price: '32€/tête', tags: ['authentique'], created_at: NOW, updated_at: NOW },
]
...
const doloSpots: LocalSpot[] = [
  { id: `${DOLO}-s1`, trip_id: DOLO, name: 'Lago di Braies', description: 'Lac de Pragser, départ AV1', category: 'nature', zone: 'Étape 1', lat: 46.6943, lng: 12.0850, price: 'parking 8€', tags: ['lac', 'photo'], created_at: NOW, updated_at: NOW },
  { id: `${DOLO}-s2`, trip_id: DOLO, name: 'Rifugio Sennes', description: 'Refuge gardé, bivouac confortable', category: 'accommodation', zone: 'Étape 1', lat: 46.6650, lng: 12.0883, price: '60€ demi-pension', tags: ['refuge', 'gardé'], created_at: NOW, updated_at: NOW },
  { id: `${DOLO}-s3`, trip_id: DOLO, name: 'Rifugio Lavarella', description: 'Bière de monastère locale', category: 'accommodation', zone: 'Étape 2', lat: 46.6411, lng: 12.0319, price: '62€ demi-pension', tags: ['refuge', 'bière'], created_at: NOW, updated_at: NOW },
  { id: `${DOLO}-s4`, trip_id: DOLO, name: 'Rifugio Lagazuoi', description: '2752 m — top du trek', category: 'accommodation', zone: 'Étape 3', lat: 46.5197, lng: 12.0231, price: '75€ demi-pension', tags: ['refuge', 'altitude'], created_at: NOW, updated_at: NOW },
  { id: `${DOLO}-s5`, trip_id: DOLO, name: 'Cinque Torri', description: 'Formation rocheuse iconique', category: 'nature', zone: 'Étape 4', lat: 46.5328, lng: 12.0747, price: null, tags: ['formation', 'unesco'], created_at: NOW, updated_at: NOW },
  { id: `${DOLO}-s6`, trip_id: DOLO, name: 'Rifugio Nuvolau', description: 'Le plus vieux refuge des Dolomites', category: 'accommodation', zone: 'Étape 4', lat: 46.5039, lng: 12.0883, price: '65€ demi-pension', tags: ['refuge', 'historique'], created_at: NOW, updated_at: NOW },
  { id: `${DOLO}-s7`, trip_id: DOLO, name: 'Lago di Coldai', description: 'Lac glaciaire, lever de soleil', category: 'nature', zone: 'Étape 5', lat: 46.4225, lng: 12.0739, price: null, tags: ['lac', 'glaciaire'], created_at: NOW, updated_at: NOW },
  { id: `${DOLO}-s8`, trip_id: DOLO, name: 'Rifugio Coldai', description: 'Dernier refuge avant La Pissa', category: 'accommodation', zone: 'Étape 5', lat: 46.4214, lng: 12.0653, price: '58€ demi-pension', tags: ['refuge'], created_at: NOW, updated_at: NOW },
]
