...
const lisboaSpots: LocalSpot[] = [
  { id: `${LISBOA}-s1`, trip_id: LISBOA, day_id: null, name: 'Casa do Bairro', description: 'Appart 2 chambres, vue tuiles', category: 'accommodation', zone: 'Alfama', lat: 38.7117, lng: -9.1303, price: '95€/nuit', tags: ['airbnb', 'central'], created_at: NOW, updated_at: NOW },
  { id: `${LISBOA}-s2`, trip_id: LISBOA, day_id: null, name: 'Miradouro de Santa Luzia', description: 'Le plus joli point de vue d\'Alfama', category: 'nature', zone: 'Alfama', lat: 38.7115, lng: -9.1294, price: null, tags: ['vue', 'gratuit'], created_at: NOW, updated_at: NOW },
  { id: `${LISBOA}-s3`, trip_id: LISBOA, day_id: null, name: 'Taberna da Rua das Flores', description: 'Petit, sans résa, magique', category: 'food', zone: 'Chiado', lat: 38.7106, lng: -9.1422, price: '30€/tête', tags: ['portugais', 'tapas'], created_at: NOW, updated_at: NOW },
  { id: `${LISBOA}-s4`, trip_id: LISBOA, day_id: null, name: 'Time Out Market', description: 'Halle de chefs', category: 'food', zone: 'Cais do Sodré', lat: 38.7066, lng: -9.1457, price: '15€/tête', tags: ['rapide'], created_at: NOW, updated_at: NOW },
  { id: `${LISBOA}-s5`, trip_id: LISBOA, day_id: null, name: 'Mosteiro dos Jerónimos', description: 'Chef-d\'œuvre manuélin', category: 'culture', zone: 'Belém', lat: 38.6979, lng: -9.2065, price: '12€', tags: ['unesco'], created_at: NOW, updated_at: NOW },
  { id: `${LISBOA}-s6`, trip_id: LISBOA, day_id: null, name: 'Pastéis de Belém', description: 'La recette originale depuis 1837', category: 'food', zone: 'Belém', lat: 38.6975, lng: -9.2030, price: '1,40€/pièce', tags: ['institution'], created_at: NOW, updated_at: NOW },
  { id: `${LISBOA}-s7`, trip_id: LISBOA, day_id: null, name: 'Mesa de Frades', description: 'Ancienne chapelle, fado vivant', category: 'nightlife', zone: 'Alfama', lat: 38.7130, lng: -9.1273, price: '45€ + boissons', tags: ['fado', 'résa'], created_at: NOW, updated_at: NOW },
  { id: `${LISBOA}-s8`, trip_id: LISBOA, day_id: null, name: 'LX Factory', description: 'Concept stores · brunch · librairie Ler Devagar', category: 'culture', zone: 'Alcântara', lat: 38.7037, lng: -9.1750, price: 'libre', tags: ['shopping', 'café'], created_at: NOW, updated_at: NOW },
]
